    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
      ...
      <nav className="flex justify-between items-center p-6 lg:px-12">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <Link to="/case-studies" className="text-purple-400 font-semibold">Case Studies</Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8">
            {filteredCaseStudies.map((study) => (
              <Card key={study.id} className="bg-white/5 border-white/10 backdrop-blur-lg hover:bg-white/10 transition-all duration-300 hover:scale-[1.02] overflow-hidden">
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <Badge className="bg-purple-600/80 text-white border-none capitalize">
                      {study.category}
                    </Badge>
                  </div>
                </div>
                ...
                <CardHeader>
                  ...
                  <p className="text-purple-400 font-semibold">{study.subtitle}</p>
                </CardHeader>
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link to="/case-studies" className="hover:text-purple-400 transition-colors">All Cases</Link></li>
                <li><Link to="/case-studies" className="hover:text-purple-400 transition-colors">Events</Link></li>
                <li><Link to="/case-studies" className="hover:text-purple-400 transition-colors">Community Building</Link></li>
                <li><Link to="/case-studies" className="hover:text-purple-400 transition-colors">Education</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-white">Resources</h4>
              <ul className="space-y-2 text-gray-400">
                <li><Link to="/research" className="hover:text-purple-400 transition-colors">Research Reports</Link></li>
                ...
                <li><Link to="/community" className="hover:text-purple-400 transition-colors">Join Community</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="https://t.me/arunphilips" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400 transition-colors">Telegram</a></li>
                <li><a href="https://mirror.xyz/communitybuild.eth" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400 transition-colors">Mirror Blog</a></li>
